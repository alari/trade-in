...
class ApplianceController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Appliance');
	...
	{
		$model=new Appliance('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Appliance']))
			$model->attributes=$_GET['Appliance'];
	...
	{
		$model=Appliance::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='appliance-form')
		{
